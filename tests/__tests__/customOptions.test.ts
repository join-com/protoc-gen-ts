...
describe('(v2) custom options', () => {
  ...
  it('[typescript_optional] makes field optional for [typescript_required_fields] messages', () => {
    type IsFieldOptional =
      | number
      | undefined extends Foo.IRequiredPropertiesTest['optionalField']
      ? true
      : false
  ...
  it('[typescript_flavor] generates flavor type', () => {
    type TestUserId_extends_UserId = TestUserId extends Flavors.UserId
      ? true
      : false
    type UserId_extends_TestUserId = Flavors.UserId extends TestUserId
      ? true
      : false
  ...
  it('[typescript_flavor] refines field types', () => {
    ...
    type TestUserId_extends_UserProfileId = TestUserId extends UserProfileId
      ? true
      : false
    type UserProfileId_extends_TestUserId = UserProfileId extends TestUserId
      ? true
      : false
