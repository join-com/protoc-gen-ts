...
export namespace Common {
  ...
  export class ExtraPkgMessage implements IExtraPkgMessage {
    public static decode(
      ...
      const message = new ExtraPkgMessage()
      while (reader.pos < end) {
        const tag = reader.uint32()
        switch (tag >>> 3) {
          case 1:
            logger.warn('field firstName is deprecated in ExtraPkgMessage')
    ...
    constructor(attrs?: IExtraPkgMessage) {
