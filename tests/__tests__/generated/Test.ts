...
// GENERATOR VERSION: 2.3.1.9b92372.1728139630
...
export namespace Foo {
  ...
  export class CustomOptionsTest extends protobufjs.Message<CustomOptionsTest> implements ConvertibleTo<ICustomOptionsTest> {
    ...
    public static encodePatched(this: void, message: ICustomOptionsTest, writer?: protobufjs.Writer): protobufjs.Writer {
      for (const fieldName of ['requiredField'] as (keyof ICustomOptionsTest)[]) {
  ...
  export class OneRequiredFieldTest extends protobufjs.Message<OneRequiredFieldTest> implements ConvertibleTo<IOneRequiredFieldTest>, IOneRequiredFieldTest {
    ...
    public static encodePatched(this: void, message: IOneRequiredFieldTest, writer?: protobufjs.Writer): protobufjs.Writer {
      for (const fieldName of ['singleRequiredField'] as (keyof IOneRequiredFieldTest)[]) {
  ...
  export class RequiredPropertiesTest extends protobufjs.Message<RequiredPropertiesTest> implements ConvertibleTo<IRequiredPropertiesTest> {
    ...
    public static decodePatched(this: void, reader: protobufjs.Reader | Uint8Array): IRequiredPropertiesTest {
      ...
      for (const fieldName of ['requiredField', 'customRequiredField', 'requiredEnumField'] as (keyof IRequiredPropertiesTest)[]) {
    ...
    public static encodePatched(this: void, message: IRequiredPropertiesTest, writer?: protobufjs.Writer): protobufjs.Writer {
      for (const fieldName of ['requiredField', 'customRequiredField', 'requiredEnumField'] as (keyof IRequiredPropertiesTest)[]) {
        const field = message[fieldName]
        if (field == null || Array.isArray(field) && (field as any[]).length === 0) {
          throw new Error(`Required field ${fieldName} in RequiredPropertiesTest is null or undefined`)
  ...
  export class Test extends protobufjs.Message<Test> implements ConvertibleTo<ITest> {
    ...
    public asInterface(): ITest {
      const message = {
        ...
        timestamp: this.timestamp != null ? new Date((this.timestamp.seconds ?? 0) * 1000 + (this.timestamp.nanos ?? 0) / 1000000) : undefined,
        timestampRepeated: this.timestampRepeated?.map((ts) => new Date((ts.seconds ?? 0) * 1000 + (ts.nanos ?? 0) / 1000000)),
    ...
    public static fromInterface(this: void, value: ITest): Test {
      const patchedValue = {
        ...
        timestamp: (value.timestamp != null) ? GoogleProtobuf_Timestamp.Timestamp.fromInterface({ seconds: Math.floor(value.timestamp.getTime() / 1000), nanos: value.timestamp.getMilliseconds() * 1000000 }) : undefined,
        timestampRepeated: value.timestampRepeated?.map((d) => GoogleProtobuf_Timestamp.Timestamp.fromInterface({ seconds: Math.floor(d.getTime() / 1000), nanos: d.getMilliseconds() * 1000000 })),
      }
  ...
  export const usersServiceDefinition: grpc.ServiceDefinition<IUsersServiceImplementation> = {
    Find: {
      ...
      responseSerialize: (response: Common_Common.IOtherPkgMessage) => Common_Common.OtherPkgMessage.encodePatched(response).finish() as Buffer,
  ...
  export abstract class AbstractUsersService extends joinGRPC.Service<IUsersServiceImplementation> {
    ...
    public abstract Find(call: grpc.ServerUnaryCall<IRequest, Common_Common.IOtherPkgMessage>): Promise<Common_Common.IOtherPkgMessage>
    public abstract FindBidiStream(call: grpc.ServerDuplexStream<IRequest, Common_Common.IOtherPkgMessage>): Promise<void>
    public abstract FindClientStream(call: grpc.ServerReadableStream<IRequest, Common_Common.IOtherPkgMessage>): Promise<Common_Common.IOtherPkgMessage>
    public abstract FindServerStream(call: grpc.ServerWritableStream<IRequest, Common_Common.IOtherPkgMessage>): Promise<void>
  }
  ...
  export const simpleTestServiceDefinition: grpc.ServiceDefinition<ISimpleTestServiceImplementation> = {
    ...
    GetEmptyResult: {
      ...
      requestStream: false,
      responseStream: false,
      requestSerialize: (request: GoogleProtobuf_Empty.IEmpty) => GoogleProtobuf_Empty.Empty.encodePatched(request).finish() as Buffer,
  ...
  export abstract class AbstractSimpleTestService extends joinGRPC.Service<ISimpleTestServiceImplementation> {
    ...
    public abstract GetEmptyResult(call: grpc.ServerUnaryCall<GoogleProtobuf_Empty.IEmpty, IBigWrapper>): Promise<IBigWrapper>
  }
