...
export namespace Regressions {
  ...
  export class DeprecatedMessageWithDeprecatedField extends protobufjs.Message<DeprecatedMessageWithDeprecatedField> implements ConvertibleTo<IDeprecatedMessageWithDeprecatedField>, IDeprecatedMessageWithDeprecatedField {
    ...
    public static fromInterface(this: void, value: IDeprecatedMessageWithDeprecatedField): DeprecatedMessageWithDeprecatedField {
      return DeprecatedMessageWithDeprecatedField.fromObject(value)
    }
    
    public static decodePatched(this: void, reader: protobufjs.Reader | Uint8Array): IDeprecatedMessageWithDeprecatedField {
      return DeprecatedMessageWithDeprecatedField.decode(reader).asInterface()
    }
    
    public static encodePatched(this: void, message: IDeprecatedMessageWithDeprecatedField, writer?: protobufjs.Writer): protobufjs.Writer {
  ...
  export class MessageWithDeprecatedField extends protobufjs.Message<MessageWithDeprecatedField> implements ConvertibleTo<IMessageWithDeprecatedField>, IMessageWithDeprecatedField {
    ...
    public static encodePatched(this: void, message: IMessageWithDeprecatedField, writer?: protobufjs.Writer): protobufjs.Writer {
